		...
		<div class="text-box">
			<div class="text-box-inner">
				...
				<div class="admin-menu">
					<form method="post">
						<div>
							<input type="hidden" name="categoryNameId" value="1">
...
<?php } ?>
<!-- 
<a href="php/tea-category-form.php?id=<?php echo $id; ?>"><h2>Delete</h2></a>
							<a href="php/tea-category-form.php?id=<?php echo $id; ?>"><h2>Update</h2></a> -->